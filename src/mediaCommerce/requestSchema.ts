...
export const mediaCommerceRequestSchema = z.object({
  ...
  free_scene_unlocks: z.coerce.number().int().nonnegative().nullable().optional(),
  free_photo_unlocks: z.coerce.number().int().nonnegative().nullable().optional(),
  free_fast_scene_skips: z.coerce.number().int().nonnegative().nullable().optional(),
